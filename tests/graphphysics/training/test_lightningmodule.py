...
def test_build_mask_prefers_named_features() -> None:
    ...
    param = {"named_features": {"node_type": "node_type"}, "index": {"node_type_index": 3}}
...
def test_training_step_with_named_layout(monkeypatch) -> None:
    ...
    monkeypatch.setattr("graphphysics.training.lightning_module.get_model", lambda param, only_processor=False: MagicMock())
    monkeypatch.setattr(
